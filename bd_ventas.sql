...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-02-2025 a las 23:20:09
...
CREATE TABLE `empleado` (
  ...
  `contraseña` varchar(255) NOT NULL DEFAULT '123'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `empleado` (`IdEmpleado`, `Dni`, `Nombres`, `Telefono`, `Estado`, `User`, `contraseña`) VALUES
(1, '1', 'Pedro Hernandez', '988252459', '1', 'emp01', '123'),
(2, '2', 'Roman Riquelme', '988252459', '1', 'Jo46', '123'),
(3, '3', 'Palermo Suarez', '453536458', '1', 'Em22', '123');
